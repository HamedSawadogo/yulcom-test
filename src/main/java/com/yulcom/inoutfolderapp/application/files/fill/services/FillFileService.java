package com.yulcom.inoutfolderapp.application.files.fill.services;
...
public class FillFileService
{
    ...
    public GetFileDto handle(UUID fileId)  {
        ...
        if (file.getStatus().equals(FileStatus.FILLED))  {
